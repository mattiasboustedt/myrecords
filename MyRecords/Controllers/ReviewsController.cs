...
namespace MyRecords.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewId,ReviewTitle,ReviewContent,ReviewerEmail,AlbumId")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewId,ReviewTitle,ReviewContent,ReviewerEmail,AlbumId")] Review review)
        {
            if (ModelState.IsValid)
            {
                review.ReviewerEmail = User.Identity.Name;
